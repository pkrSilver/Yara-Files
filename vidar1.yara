rule vidar1
{
	...
	strings:
		...
		$x5 = { 00 00 00 00 60 64 79 6E 61 6D 69 63 20 69 6E 69 74 69 61 6C 69 7A 65 72 20 66 6F 72 20 27 00 00 } //This might be a string? Looks like:`dynamic initializer for '
		...
		$x62 = { AE A0 AE B0 AE B8 AE C8 AE D0 AE E0 AE E8 AE F8 AE 00 AF 10 AF 18 AF 28 AF 30 AF 40 AF 48 AF 58 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 4.265319531114783 Found in 6 files
		$x63 = { 06 09 05 0C 08 06 07 04 0A 17 09 09 0C 17 0B 1F 0E 10 0D 3B 00 02 0B 10 07 90 01 8E 02 8F 01 01 } 
		...
		$x81 = { 20 A4 30 A4 38 A4 48 A4 50 A4 60 A4 68 A4 78 A4 80 A4 90 A4 98 A4 A8 A4 B0 A4 C0 A4 C8 A4 D8 A4 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.9650182662886326 Found in 13 files
		$x86 = { 6C 6C 65 72 53 74 61 74 65 29 2E 73 74 61 72 74 43 79 63 6C 65 00 72 75 6E 74 69 6D 65 2E 28 2A } //This might be a string? Looks like:llerState).startCycleruntime.(*
		...
		$x89 = { 00 E9 9B FD FF FF CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 4.288909765557392 Found in 13 files
		$x90 = { 2E 62 67 73 63 61 76 65 6E 67 65 00 72 75 6E 74 69 6D 65 2E 28 2A 70 61 67 65 41 6C 6C 6F 63 29 } //This might be a string? Looks like:.bgscavengeruntime.(*pageAlloc)
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.988608500731241 Found in 8 files
		$x92 = { 72 65 73 65 74 4C 69 76 65 00 72 75 6E 74 69 6D 65 2E 28 2A 67 63 43 6F 6E 74 72 6F 6C 6C 65 72 } //This might be a string? Looks like:resetLiveruntime.(*gcController
		...
		$x93 = { AF 08 AF 10 AF 18 AF 20 AF 28 AF 30 AF 38 AF 40 AF 48 AF 50 AF 58 AF 60 AF 68 AF 70 AF 78 AF 80 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 4.202819531114783 Found in 13 files
		$x94 = { 63 50 61 72 6B 41 73 73 69 73 74 00 72 75 6E 74 69 6D 65 2E 28 2A 67 51 75 65 75 65 29 2E 70 75 } //This might be a string? Looks like:cParkAssistruntime.(*gQueue).pu
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 4.5625 Found in 11 files
		$x95 = { 24 18 31 C0 31 DB EB 03 48 FF C0 48 39 D0 7D 33 48 8B 34 C1 83 7E 04 01 75 EE 48 89 44 24 10 88 } 
		...
		$x104 = { 2E 43 6C 6F 73 65 48 61 6E 64 6C 65 00 73 79 73 63 61 6C 6C 2E 43 72 65 61 74 65 46 69 6C 65 4D } //This might be a string? Looks like:.CloseHandlesyscall.CreateFileM
		...
		$x110 = "xecutionLevel level='asInvoker' " ascii
		...
		$x112 = { 6E 61 6C 2F 70 6F 6C 6C 2E 28 2A 70 6F 6C 6C 44 65 73 63 29 2E 69 6E 69 74 00 69 6E 74 65 72 6E } //This might be a string? Looks like:nal/poll.(*pollDesc).initintern
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.448019116267279 Found in 13 files
		$x117 = { D8 A1 E0 A1 E8 A1 F0 A1 F8 A1 00 A2 08 A2 10 A2 18 A2 20 A2 28 A2 30 A2 38 A2 40 A2 48 A2 50 A2 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.4772170014624826 Found in 30 files
		$x118 = { A4 D8 A4 E0 A4 E8 A4 F0 A4 F8 A4 00 A5 08 A5 10 A5 18 A5 20 A5 28 A5 30 A5 38 A5 40 A5 48 A5 50 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.271782221599798 Found in 7 files
		$x119 = { A8 F8 A8 08 A9 10 A9 20 A9 28 A9 38 A9 40 A9 50 A9 58 A9 68 A9 70 A9 80 A9 88 A9 98 A9 A0 A9 B0 } 
		...
		$x123 = { A1 30 A1 38 A1 48 A1 50 A1 60 A1 68 A1 78 A1 80 A1 90 A1 98 A1 A8 A1 B0 A1 C0 A1 C8 A1 D8 A1 E0 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.494349704144249 Found in 13 files
		$x126 = { A1 B8 A1 C0 A1 D0 A1 D8 A1 E8 A1 F0 A1 00 A2 08 A2 18 A2 20 A2 30 A2 38 A2 48 A2 50 A2 60 A2 68 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 2.287101752714581 Found in 9 files
		$x128 = { 04 05 02 05 02 03 02 02 08 03 02 03 02 03 02 04 02 03 02 04 02 08 02 01 08 08 02 03 02 02 06 04 } 
		...
		$x131 = { AB 00 AC 10 AC 18 AC 28 AC 30 AC 40 AC 48 AC 58 AC 60 AC 70 AC 78 AC 88 AC 90 AC A0 AC A8 AC B8 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 2.147589457504889 Found in 10 files
		$x136 = { 02 02 02 02 02 02 02 02 02 02 13 03 03 03 03 03 03 03 03 03 03 03 03 23 03 03 34 04 04 04 44 F1 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.9025182662886326 Found in 11 files
		$x139 = { 00 69 6E 74 65 72 6E 61 6C 2F 72 65 66 6C 65 63 74 6C 69 74 65 2E 28 2A 72 74 79 70 65 29 2E 43 } //This might be a string? Looks like:internal/reflectlite.(*rtype).C
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.494349704144249 Found in 12 files
		$x140 = { A3 B8 A3 C0 A3 D0 A3 D8 A3 E8 A3 F0 A3 00 A4 08 A4 18 A4 20 A4 30 A4 38 A4 48 A4 50 A4 60 A4 68 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.3481061300625727 Found in 12 files
		$x142 = { A8 70 A8 80 A8 88 A8 98 A8 A0 A8 B0 A8 B8 A8 C8 A8 D0 A8 E0 A8 E8 A8 F8 A8 00 A9 10 A9 18 A9 28 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.4772170014624826 Found in 7 files
		$x143 = { AB B0 AB B8 AB E0 AB E8 AB F8 AB 00 AC 10 AC 18 AC 28 AC 30 AC 40 AC 48 AC 58 AC 60 AC 70 AC 78 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 2.9375 Found in 9 files
		$x144 = { 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 30 77 AF 0C 92 74 08 02 41 E1 C1 07 E6 D6 18 E6 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.5931390622295662 Found in 12 files
		$x148 = { 63 61 6C 6C 2E 28 2A 50 72 6F 63 29 2E 43 61 6C 6C 00 73 79 73 63 61 6C 6C 2E 28 2A 50 72 6F 63 } //This might be a string? Looks like:call.(*Proc).Callsyscall.(*Proc
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 4.538909765557392 Found in 14 files
		$x150 = { 54 46 31 36 50 74 72 46 72 6F 6D 53 74 72 69 6E 67 00 73 79 73 63 61 6C 6C 2E 28 2A 44 4C 4C 29 } //This might be a string? Looks like:TF16PtrFromStringsyscall.(*DLL)
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 4.226409765557392 Found in 9 files
		$x152 = { 2E 28 2A 46 72 61 6D 65 73 29 2E 4E 65 78 74 00 72 75 6E 74 69 6D 65 2E 65 78 70 61 6E 64 43 67 } //This might be a string? Looks like:.(*Frames).Nextruntime.expandCg
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 4.202819531114783 Found in 13 files
		$x153 = { 6D 65 2E 67 66 70 75 72 67 65 00 72 75 6E 74 69 6D 65 2E 75 6E 6C 6F 63 6B 4F 53 54 68 72 65 61 } //This might be a string? Looks like:me.gfpurgeruntime.unlockOSThrea
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 4.038909765557392 Found in 9 files
		$x154 = { 2E 28 2A 72 74 79 70 65 29 2E 43 6F 6D 70 61 72 61 62 6C 65 00 69 6E 74 65 72 6E 61 6C 2F 72 65 } //This might be a string? Looks like:.(*rtype).Comparableinternal/re
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.4772170014624826 Found in 11 files
		$x156 = { A5 98 A5 A0 A5 B0 A5 B8 A5 C8 A5 D0 A5 E0 A5 E8 A5 F8 A5 00 A6 10 A6 18 A6 28 A6 30 A6 40 A6 48 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.0 Found in 11 files
		$x157 = { 50 AF 58 AF 60 AF 68 AF 70 AF 78 AF 80 AF 88 AF 90 AF 98 AF A0 AF A8 AF B0 AF B8 AF C0 AF C8 AF } 
		...
		$x160 = { 6C 62 61 63 6B 5F 77 69 6E 64 6F 77 73 2E 73 00 69 6E 74 65 72 6E 61 6C 2F 73 79 73 63 61 6C 6C } //This might be a string? Looks like:lback_windows.sinternal/syscall
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.9025182662886326 Found in 12 files
		$x161 = { 6C 65 43 6F 6D 70 6C 65 74 69 6F 6E 4E 6F 74 69 66 69 63 61 74 69 6F 6E 4D 6F 64 65 73 00 73 79 } //This might be a string? Looks like:leCompletionNotificationModessy
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.5 Found in 15 files
		$x162 = { C0 AE C8 AE D0 AE D8 AE E0 AE E8 AE F0 AE F8 AE 00 AF 08 AF 10 AF 18 AF 20 AF 28 AF 30 AF 38 AF } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 4.75 Found in 16 files
		$x163 = { 3F 67 21 A0 FA B3 AB E3 3F 8B 1B CD 4B 78 9A E4 3F 34 9D 98 26 82 84 E5 3F CC 88 47 8E 00 6A E6 } 
		...
		$x7 = { 70 A9 80 A9 90 A9 A0 A9 B0 A9 C0 A9 D0 A9 E0 A9 F0 A9 00 AA 10 AA 20 AA 30 AA 40 AA 50 AA 60 AA } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.7264097655573916 Found in 27 files
		$x9 = { 20 69 74 65 72 61 74 6F 72 27 00 00 00 00 60 65 68 20 76 65 63 74 6F 72 20 64 65 73 74 72 75 63 } //This might be a string? Looks like: iterator'`eh vector destruc
		...
		$x179 = { 6D 65 2F 72 75 6E 74 69 6D 65 32 2E 67 6F 00 72 75 6E 74 69 6D 65 2F 70 72 6F 63 2E 67 6F 00 72 } //This might be a string? Looks like:me/runtime2.goruntime/proc.gor
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.863608500731241 Found in 11 files
		$x180 = { 63 61 6C 6C 2E 43 72 65 61 74 65 46 69 6C 65 4D 61 70 70 69 6E 67 00 73 79 73 63 61 6C 6C 2E 43 } //This might be a string? Looks like:call.CreateFileMappingsyscall.C
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 4.75 Found in 6 files
		$x181 = { F0 48 0F B1 5A 20 40 0F 94 C6 90 40 84 F6 74 D5 48 83 F9 02 75 04 31 C9 EB 16 FF 4C 24 14 EB 10 } 
		...
		$x183 = { 72 6C 64 47 43 00 72 75 6E 74 69 6D 65 2E 73 74 6F 70 54 68 65 57 6F 72 6C 64 57 69 74 68 53 65 } //This might be a string? Looks like:rldGCruntime.stopTheWorldWithSe
		...
		$x184 = { 6C 65 61 73 65 00 73 79 6E 63 2E 72 75 6E 74 69 6D 65 5F 6E 6F 74 69 66 79 4C 69 73 74 43 68 65 } //This might be a string? Looks like:leasesync.runtime_notifyListChe
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.0 Found in 12 files
		$x187 = { 10 AF 18 AF 20 AF 28 AF 30 AF 38 AF 40 AF 48 AF 50 AF 58 AF 60 AF 68 AF 70 AF 78 AF 80 AF 88 AF } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.3481061300625727 Found in 9 files
		$x188 = { 60 A3 70 A3 78 A3 88 A3 90 A3 A0 A3 A8 A3 B8 A3 C0 A3 D0 A3 D8 A3 E8 A3 F0 A3 00 A4 08 A4 18 A4 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.448019116267279 Found in 10 files
		$x190 = { AD D8 AD E0 AD F0 AD F8 AD 08 AE 10 AE 20 AE 28 AE 38 AE 40 AE 50 AE 58 AE 68 AE 70 AE 80 AE 88 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 4.375 Found in 10 files
		$x192 = { 1E 3A 0C 1F 0F 97 C0 48 8D 04 45 FF FF FF FF C3 49 83 F8 08 76 0B 48 8B 06 48 8B 0F 48 39 C8 75 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 4.265319531114783 Found in 11 files
		$x195 = { 65 72 73 79 73 63 61 6C 6C 62 6C 6F 63 6B 5F 68 61 6E 64 6F 66 66 00 72 75 6E 74 69 6D 65 2E 65 } //This might be a string? Looks like:ersyscallblock_handoffruntime.e
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.9917292966721747 Found in 9 files
		$x196 = { 50 61 74 68 45 72 72 6F 72 00 69 6E 74 65 72 6E 61 6C 2F 73 79 73 63 61 6C 6C 2F 77 69 6E 64 6F } //This might be a string? Looks like:PathErrorinternal/syscall/windo
		...
		$x199 = { A7 E8 A7 F0 A7 F8 A7 00 A8 08 A8 10 A8 18 A8 20 A8 28 A8 30 A8 38 A8 40 A8 48 A8 50 A8 58 A8 60 } 
		...
		$x4 = { D0 A3 E0 A3 F0 A3 00 A4 10 A4 20 A4 30 A4 40 A4 50 A4 60 A4 70 A4 80 A4 90 A4 A0 A4 B0 A4 C0 A4 } 
		...
		$x3 = { D4 D5 D6 D7 D8 D9 DA DB DC DD DE DF E0 E1 E2 E3 E4 E5 E6 E7 E8 E9 EA EB EC ED EE EF F0 F1 F2 F3 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.0 Found in 10 files
		...
		$x76 = { 67 6F 00 69 6E 74 65 72 6E 61 6C 2F 72 65 66 6C 65 63 74 6C 69 74 65 2F 74 79 70 65 2E 67 6F 00 } //This might be a string? Looks like:gointernal/reflectlite/type.go
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 4.179229296672174 Found in 34 files
		$x77 = { 72 75 73 74 49 6E 66 6F 20 78 6D 6C 6E 73 3D 22 75 72 6E 3A 73 63 68 65 6D 61 73 2D 6D 69 63 72 } //This might be a string? Looks like:rustInfo xmlns="urn:schemas-micr
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.271782221599798 Found in 9 files
		$x78 = { E8 A6 F8 A6 00 A7 10 A7 18 A7 28 A7 30 A7 40 A7 48 A7 58 A7 60 A7 70 A7 78 A7 88 A7 90 A7 A0 A7 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 4.8125 Found in 7 files
		$x79 = { 81 E0 F8 FF 7F 00 49 89 D9 48 C1 EB 0D 4A 8B 34 06 45 31 C0 EB 11 41 84 00 4B 89 3C D0 4C 8D 56 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 4.054229296672174 Found in 7 files
		$x80 = { 74 69 6D 65 2E 70 69 43 6F 6E 74 72 6F 6C 6C 65 72 01 15 43 6F 6D 70 61 72 65 41 6E 64 53 77 61 } //This might be a string? Looks like:time.piControllerCompareAndSwa
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 4.3125 Found in 14 files
		$x82 = { 72 6E 61 6C 2F 62 79 74 65 61 6C 67 2F 63 6F 6D 70 61 72 65 5F 61 6D 64 36 34 2E 73 00 69 6E 74 } //This might be a string? Looks like:rnal/bytealg/compare_amd64.sint
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 4.163909765557392 Found in 8 files
		$x83 = { 4D 89 DC 4C 0F 47 DB 4D 89 E5 4D 29 DC 49 89 C0 4C 89 E8 F0 4D 0F B1 A0 90 01 01 00 41 0F 94 C4 } 
		...
		$x84 = { 00 00 00 00 00 00 00 00 00 00 00 00 00 00 20 21 22 23 24 25 25 26 26 27 27 28 28 28 29 29 29 2A } //This might be a string? Looks like: !"#$%%&&''((()))*
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.0 Found in 14 files
		$x85 = { A2 10 A2 18 A2 20 A2 28 A2 30 A2 38 A2 40 A2 48 A2 50 A2 58 A2 60 A2 68 A2 70 A2 78 A2 80 A2 88 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 4.093139062229566 Found in 5 files
		$x88 = { 24 68 48 89 0C 24 48 89 C3 31 C9 48 89 CF 31 F6 41 B8 04 00 00 00 45 31 C9 4D 89 CA 4C 8D 9C 24 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 4.054229296672174 Found in 9 files
		$x91 = { 6F 6C 6C 65 72 53 74 61 74 65 29 2E 69 6E 69 74 00 72 75 6E 74 69 6D 65 2E 28 2A 67 63 43 6F 6E } //This might be a string? Looks like:ollerState).initruntime.(*gcCon
		...
		$x103 = { 2D 74 72 69 6D 70 61 74 68 3D 74 72 75 65 0A 62 75 69 6C 64 09 43 47 4F 5F 45 4E 41 42 4C 45 44 } //This might be a string? Looks like:-trimpath=true\nbuild\tCGO_ENABLED
		...
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.0 Found in 9 files
		$x111 = { A1 08 A1 18 A1 20 A1 30 A1 38 A1 48 A1 50 A1 60 A1 68 A1 78 A1 80 A1 90 A1 98 A1 A8 A1 B0 A1 C0 } 
		...
		$x113 = { A5 98 A5 A0 A5 A8 A5 B0 A5 B8 A5 C0 A5 C8 A5 D0 A5 D8 A5 E0 A5 E8 A5 F0 A5 F8 A5 00 A6 08 A6 10 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 4.218139062229566 Found in 6 files
		$x114 = { 63 72 65 66 00 69 6E 74 65 72 6E 61 6C 2F 70 6F 6C 6C 2E 28 2A 46 44 29 2E 77 72 69 74 65 55 6E } //This might be a string? Looks like:crefinternal/poll.(*FD).writeUn
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.369349704144249 Found in 6 files
		$x115 = { 18 A2 58 A2 60 A2 70 A2 78 A2 B8 A2 C0 A2 D0 A2 D8 A2 18 A3 20 A3 30 A3 38 A3 78 A3 80 A3 90 A3 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.292837797403416 Found in 8 files
		$x116 = { 80 A8 90 A8 98 A8 A8 A8 B0 A8 C0 A8 C8 A8 D8 A8 E0 A8 F0 A8 F8 A8 08 A9 10 A9 20 A9 28 A9 38 A9 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 4.038909765557392 Found in 10 files
		$x120 = { 61 74 65 46 69 6C 65 4D 61 70 70 69 6E 67 00 73 79 73 63 61 6C 6C 2E 43 72 65 61 74 65 50 72 6F } //This might be a string? Looks like:ateFileMappingsyscall.CreatePro
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.688307235905091 Found in 12 files
		$x121 = " not enabledno goroutines (main " ascii
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 4.413909765557392 Found in 5 files
		$x124 = { 4C 61 7A 79 50 72 6F 63 00 11 2A 5B 30 5D 2A 62 69 73 65 63 74 2E 64 65 64 75 70 00 11 2A 5B 5D } //This might be a string? Looks like:LazyProc*[0]*bisect.dedup*[]
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 4.241729296672174 Found in 10 files
		$x125 = { 73 63 61 6C 6C 2F 77 69 6E 64 6F 77 73 2E 57 53 41 4D 73 67 00 69 6E 74 65 72 6E 61 6C 2F 70 6F } //This might be a string? Looks like:scall/windows.WSAMsginternal/po
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 5.0 Found in 28 files
		$x8 = { 55 56 57 58 59 5A 5B 5C 5D 5E 5F 60 61 62 63 64 65 66 67 68 69 6A 6B 6C 6D 6E 6F 70 71 72 73 74 } //This might be a string? Looks like:UVWXYZ[\]^_`abcdefghijklmnopqrst
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.0 Found in 8 files
		$x127 = { AD 20 AD 30 AD 38 AD 48 AD 50 AD 60 AD 68 AD 78 AD 80 AD 90 AD 98 AD A8 AD B0 AD C0 AD C8 AD D8 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.4056390622295662 Found in 11 files
		$x129 = { A6 80 A6 88 A6 98 A6 A0 A6 B0 A6 B8 A6 C8 A6 D0 A6 E0 A6 E8 A6 F8 A6 00 A7 10 A7 18 A7 28 A7 30 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.9292292966721747 Found in 10 files
		$x130 = { 31 00 72 75 6E 74 69 6D 65 2E 67 66 70 75 72 67 65 00 72 75 6E 74 69 6D 65 2E 75 6E 6C 6F 63 6B } //This might be a string? Looks like:1runtime.gfpurgeruntime.unlock
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.271782221599798 Found in 10 files
		$x132 = { A5 68 A5 70 A5 80 A5 88 A5 98 A5 A0 A5 B0 A5 B8 A5 C8 A5 D0 A5 E0 A5 E8 A5 F8 A5 00 A6 10 A6 18 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 4.476409765557392 Found in 15 files
		$x133 = { 64 44 4C 4C 00 73 79 73 63 61 6C 6C 2E 55 54 46 31 36 50 74 72 46 72 6F 6D 53 74 72 69 6E 67 00 } //This might be a string? Looks like:dDLLsyscall.UTF16PtrFromString
		...
		$x134 = { D8 A2 E0 A2 E8 A2 F0 A2 F8 A2 00 A3 08 A3 10 A3 18 A3 20 A3 28 A3 30 A3 38 A3 40 A3 48 A3 50 A3 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.371696364505181 Found in 7 files
		$x135 = { AB F8 AB 00 AC 10 AC 18 AC 58 AC 60 AC 70 AC 78 AC A0 AC A8 AC B8 AC C0 AC D0 AC D8 AC 18 AD 20 } 
		...
		$x137 = { 20 20 3C 74 72 75 73 74 49 6E 66 6F 20 78 6D 6C 6E 73 3D 22 75 72 6E 3A 73 63 68 65 6D 61 73 2D } //This might be a string? Looks like:  <trustInfo xmlns="urn:schemas-
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.0 Found in 6 files
		$x138 = { AF 20 AF 30 AF 38 AF 60 AF 68 AF 78 AF 80 AF 90 AF 98 AF A8 AF B0 AF C0 AF C8 AF D8 AF E0 AF F0 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.7806390622295662 Found in 13 files
		$x141 = { 67 6F 00 72 75 6E 74 69 6D 65 2F 6D 63 65 6E 74 72 61 6C 2E 67 6F 00 72 75 6E 74 69 6D 65 2F 6D } //This might be a string? Looks like:goruntime/mcentral.goruntime/m
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.702819531114783 Found in 9 files
		$x145 = { 72 75 6E 74 69 6D 65 2E 6D 61 70 61 63 63 65 73 73 32 00 72 75 6E 74 69 6D 65 2E 6D 61 70 61 73 } //This might be a string? Looks like:runtime.mapaccess2runtime.mapas
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 2.5568497041442484 Found in 8 files
		$x146 = { E8 9A EB FF FF E8 95 EB FF FF E8 90 EB FF FF E8 8B EB FF FF E8 86 EB FF FF E8 81 EB FF FF E8 7C } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.902518266288633 Found in 6 files
		$x147 = { 39 00 00 84 C0 0F 85 F8 00 00 00 48 8B 44 24 78 48 8B 7C 24 38 4C 8B 44 24 28 0F B6 4C 24 16 48 } //This might be a string? Looks like:9HD$xH|$8LD$(L$H
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.3481061300625727 Found in 8 files
		$x149 = { AB D0 AB D8 AB 00 AC 08 AC 18 AC 20 AC 30 AC 38 AC 48 AC 50 AC 60 AC 68 AC 78 AC 80 AC 90 AC 98 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.4056390622295662 Found in 10 files
		$x151 = { D0 AD D8 AD E8 AD F0 AD 00 AE 08 AE 18 AE 20 AE 30 AE 38 AE 48 AE 50 AE 60 AE 68 AE 78 AE 80 AE } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.0 Found in 15 files
		$x155 = { A2 28 A2 30 A2 38 A2 40 A2 48 A2 50 A2 58 A2 60 A2 68 A2 70 A2 78 A2 80 A2 88 A2 90 A2 98 A2 A0 } 
		...
		$x158 = { AE B8 AE C0 AE C8 AE D0 AE D8 AE E0 AE E8 AE F0 AE F8 AE 00 AF 08 AF 10 AF 18 AF 20 AF 28 AF 30 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 2.484265829249441 Found in 15 files
		$x159 = { 08 05 02 05 02 03 02 03 02 01 06 04 02 02 04 08 02 03 04 04 02 02 06 03 02 02 06 05 02 03 08 04 } 
		...
		$x6 = { 00 00 00 60 64 65 66 61 75 6C 74 20 63 6F 6E 73 74 72 75 63 74 6F 72 20 63 6C 6F 73 75 72 65 27 } //This might be a string? Looks like:`default constructor closure'
		...
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.1686450333085068 Found in 8 files
		$x182 = { F8 A6 20 A7 28 A7 38 A7 40 A7 50 A7 58 A7 68 A7 70 A7 80 A7 88 A7 98 A7 A0 A7 B0 A7 B8 A7 C8 A7 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 4.1761085007312415 Found in 15 files
		$x185 = { 08 48 83 C6 10 48 83 C7 10 48 0F BC D8 48 31 C0 8A 0C 1E 3A 0C 1F 0F 97 C0 48 8D 04 45 FF FF FF } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 1.1183927290103626 Found in 11 files
		$x186 = { 90 E9 FB FD FF FF CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 5.0 Found in 29 files
		$x19 = { 73 A8 0F 26 60 40 13 01 3C 0A 88 71 CC 21 2D A5 37 EF C9 DA 8A B4 31 BB 42 41 4C F9 D6 6C 05 8B } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 4.051108500731241 Found in 14 files
		$x189 = "ng with NUL passed to StringToUT" ascii
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.6792292966721747 Found in 9 files
		$x191 = { 63 00 72 75 6E 74 69 6D 65 2E 67 63 69 6E 69 74 00 72 75 6E 74 69 6D 65 2E 67 63 65 6E 61 62 6C } //This might be a string? Looks like:cruntime.gcinitruntime.gcenabl
		...
		$x193 = { 63 6F 64 65 2F 75 74 66 31 36 2F 75 74 66 31 36 2E 67 6F 00 69 6E 74 65 72 6E 61 6C 2F 72 65 66 } //This might be a string? Looks like:code/utf16/utf16.gointernal/ref
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.4056390622295662 Found in 12 files
		$x194 = { A1 D8 A1 E8 A1 F0 A1 00 A2 08 A2 18 A2 20 A2 30 A2 38 A2 48 A2 50 A2 60 A2 68 A2 78 A2 80 A2 90 } 
		//Benign FP est: -0.0 Malicious FP est: -0.0 Entropy: 3.0 Found in 11 files
		$x197 = { A4 48 A4 50 A4 60 A4 68 A4 78 A4 80 A4 90 A4 98 A4 A8 A4 B0 A4 C0 A4 C8 A4 D8 A4 E0 A4 F0 A4 F8 } 
